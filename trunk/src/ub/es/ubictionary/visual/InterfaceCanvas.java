 ...
 * @author aram
 */
public class InterfaceCanvas extends Canvas implements CommandListener{
    ...
    public InterfaceCanvas(UBictionary midlet, String selectedLanguage) {
        this.midlet = midlet;
        ...
        lista.setItems(midlet.cfg.getLanguages());
        lista.setSelectedByValue(selectedLanguage);
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (command == cmdVolver){  //Mostar el Menu principal
            midlet.cfg.setLanguage(lista.getSelectedText());
    ...
    protected void paint(Graphics g) {
        ...
        g.setColor(255, 255, 255);
        g.drawString(midlet.cfg.getPalabra("idioma"), getWidth()/2, 1, g.TOP|g.HCENTER);
